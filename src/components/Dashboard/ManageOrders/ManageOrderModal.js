...
export default function ManageOrderModal({ orderData }) {
            ...
            <div className='px-3 py-4' ref={printRef}>
              <div className='modal-body'>
                ...
                <div className='row'>
                  ...
                  <div className='customer_details col-md-6'>
                    <div className='customer_info my-4'>
                      ...
                      <p>
                        Name : <strong>{customer_details?.name}</strong>
                      </p>
                      <p>
                        Email : <strong>{customer_details?.email}</strong>
                      </p>
                      <p>
                        Phone : <strong>{customer_details?.phone}</strong>
                      </p>
                    </div>
                  </div>
                ...
                <div className='card-body mt-4'>
                  <div className='row flex-column-reverse flex-md-row row-gap-4 row-gap-md-0'>
                    <div className='col-md-6 d-flex align-items-end'></div>
